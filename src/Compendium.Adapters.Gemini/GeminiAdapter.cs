// -----------------------------------------------------------------------
// <copyright file="GeminiAdapter.cs" company="Sassy Solutions">
...
namespace Compendium.Adapters.Gemini;

/// <summary>
/// Gemini adapter — replace with the real vendor implementation.
...
/// </list>
/// </summary>
public sealed class GeminiAdapter
{
    private readonly GeminiOptions _options;
    private readonly ILogger<GeminiAdapter> _logger;

    /// <summary>
    /// Creates a new <see cref="GeminiAdapter"/>.
    /// </summary>
    /// <param name="options">Adapter configuration.</param>
    /// <param name="logger">Diagnostic logger.</param>
    public GeminiAdapter(IOptions<GeminiOptions> options, ILogger<GeminiAdapter> logger)
    {
