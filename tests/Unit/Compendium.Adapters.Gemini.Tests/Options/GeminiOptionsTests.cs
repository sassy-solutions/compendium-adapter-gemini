...
namespace Compendium.Adapters.Gemini.Tests.Options;
...
{
    [Fact]
    public void GeminiOptions_Defaults_AreSensible()
    {
        // Arrange / Act
    ...
    public void GeminiOptions_DataAnnotations_ValidateAsExpected(
        string baseUrl,
        string apiKey,
        bool expectedValid)
    {
        // Arrange
        var options = new GeminiOptions { BaseUrl = baseUrl, ApiKey = apiKey };
    ...
    [Fact]
    public void GeminiOptions_SectionName_IsCanonical()
    {
        // Assert
        GeminiOptions.SectionName.Should().Be("Compendium:Adapters:Gemini");
    }
}
